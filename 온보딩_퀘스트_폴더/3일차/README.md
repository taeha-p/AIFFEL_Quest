...
---
# 개인적인 소감
세계에서 가장 도전적인 CEO들의 기사를 보며 AI의 발전에 경외심이 들며 동시에 현재 우리의 위치는 어디인지 궁금하게 되었다.
위의 기사들을 보면 *마크 주커버그*의 "자비스"는 인간의 자리를 대신해 다양한 일을 할 수 있는 대체품의 역할을 할수 있는 가능성을 보였고, *샘 알트만*의 GPT-4는 그에 따르면 "인간은 창의적이기에 대체품이 아니라 도구로써 사용할수 있을것이다"라고 하였다. 어떻게 보면 상반된 주장을 펼치고 있는것만 같다. n차 산업혁명의 격동기 속에서 더욱더 ai가 그 중심에 있다고 확신이 든다.

#리뷰어: 박태하

#제목: 	새출발 한화오션, 아픈 손가락 SBM 매각
...
###https://www.thebell.co.kr/free/content/ArticleView.asp?key=202309061300592920108046&lcode=00
